...
import { mergeObj, merge } from './index.js'

describe('object/mergeObj', () => {
  it('should merge', () => {
    const obj = { a: { b: { c: 1 } } }
    const target = {}
    assert.deepStrictEqual(mergeObj(target, obj), obj)
  })
